...
func fetchSunInfo(sessionData SessionData, output string) {
	...
	events := []struct {
	...
	}{
		{
			...
			helpers.FormatLocalDateTime(sunInfo.Sunrise, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.Sunrise, helpers.Time),
		},
		{
			"Sunset",
			strconv.FormatInt(sunInfo.Sunset, 10),
			helpers.FormatLocalDateTime(sunInfo.Sunset, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.Sunset, helpers.Time),
		},
		{
			"Solar Noon",
			strconv.FormatInt(sunInfo.Transit, 10),
			helpers.FormatLocalDateTime(sunInfo.Transit, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.Transit, helpers.Time),
		},
		{
			"Civil Twilight Begin",
			strconv.FormatInt(sunInfo.CivilTwilightBegin, 10),
			helpers.FormatLocalDateTime(sunInfo.CivilTwilightBegin, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.CivilTwilightBegin, helpers.Time),
		},
		{
			"Civil Twilight End",
			strconv.FormatInt(sunInfo.CivilTwilightEnd, 10),
			helpers.FormatLocalDateTime(sunInfo.CivilTwilightEnd, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.CivilTwilightEnd, helpers.Time),
		},
		{
			"Nautical Twilight Begin",
			strconv.FormatInt(sunInfo.NauticalTwilightBegin, 10),
			helpers.FormatLocalDateTime(sunInfo.NauticalTwilightBegin, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.NauticalTwilightBegin, helpers.Time),
		},
		{
			"Nautical Twilight End",
			strconv.FormatInt(sunInfo.NauticalTwilightEnd, 10),
			helpers.FormatLocalDateTime(sunInfo.NauticalTwilightEnd, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.NauticalTwilightEnd, helpers.Time),
		},
		{
			"Astronomical Twilight Begin",
			strconv.FormatInt(sunInfo.AstronomicalTwilightBegin, 10),
			helpers.FormatLocalDateTime(sunInfo.AstronomicalTwilightBegin, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.AstronomicalTwilightBegin, helpers.Time),
		},
		{
			"Astronomical Twilight End",
			strconv.FormatInt(sunInfo.AstronomicalTwilightEnd, 10),
			helpers.FormatLocalDateTime(sunInfo.AstronomicalTwilightEnd, helpers.Time),
			helpers.FormatUTCDateTime(sunInfo.AstronomicalTwilightEnd, helpers.Time),
		},
	}
