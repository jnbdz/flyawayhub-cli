...
func fetchInstructors(sessionData SessionData) {
	...
	table := tablewriter.NewWriter(os.Stdout)
	table.SetHeader([]string{"#", "ID", "User ID", "Name", "Location ID", "Location airport code"})
...
func fetchSchedules(sessionData SessionData) {
	...
	table := tablewriter.NewWriter(os.Stdout)
	table.SetHeader([]string{"#", "ID", "Start Time", "End Time"})
...
// flight type https://api.prod.flyawayhub.com/v1/flighttypes/78114770-a7e3-11eb-bd86-acde48001122
// people https://api.prod.flyawayhub.com/v1/members/78114770-a7e3-11eb-bd86-acde48001122/people?expand=location
